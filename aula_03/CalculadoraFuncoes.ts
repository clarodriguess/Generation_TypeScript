...
function obterNumeros():[number, number]{
    //function obterNumeros -vai retornar uma desestruturacao []
...
// function nome(parametro1: tipo, parametro2:tipo):tipo do retorno{}
...
function sobre():void{
    console.log("Programa desenvolvido por Clarisse")
}